...
/**
 * Created by Prateek on 27/08/17.
 */
...
public class ArcTranslateAnimation extends Animation {
    ...
    public ArcTranslateAnimation(WeatherFragment weatherFragment, ImageView mImageViewSun) {
        this.mContext = weatherFragment.getContext();
        this.mImageViewSun = mImageViewSun;
    }
