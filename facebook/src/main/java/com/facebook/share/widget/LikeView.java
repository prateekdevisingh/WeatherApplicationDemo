...
public class LikeView extends FrameLayout {
    ...
    private OnLikePageListener onLikePageListener;
    ...
    private void updateLikeStateAndLayout() {
     ...
     try {
         if (likeActionController == null) {
             ...
             if (onLikePageListener != null) {
                 onLikePageListener.onLikePage("", false);
             }
         } else {
             ...
             if (onLikePageListener != null) {
                 onLikePageListener.onLikePage(likeActionController.getLikeCountString(), likeActionController.isObjectLiked());
             }
    ...
    public interface OnLikePageListener {
        void onLikePage(String totalLike, boolean isLike);

    }
    public void setOnLikePageListener(OnLikePageListener onLikePageListener){
        this.onLikePageListener = onLikePageListener;
    }
